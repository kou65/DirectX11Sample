...
bool Window::Create()
{
	...
	std::wstring wclass_name;
	Utility::IOFunction::ToWString1(m_class_name,wclass_name);

	std::wstring wtitle_name;
		Utility::IOFunction::ToWString1(m_class_name, wtitle_name);
